...
auto computed_goto(Gba& gba)
{
    ...
    #define DISPATCH() \
        ...
        if (!CPU.cpsr.T || gba.cycles2 >= 280896) { return; } opcode = fetch(gba); goto *table[(opcode>>6)&0x3FF];
	...
	_29:
	_30:
	_31: move_shifted_register<0>(gba, opcode); DISPATCH();
	_32:
	_33:
	_34:
	_35:
	...
	_61:
	_62:
	_63: move_shifted_register<1>(gba, opcode); DISPATCH();
	_64:
	_65:
	_66:
	_67:
	...
	_93:
	_94:
	_95: move_shifted_register<2>(gba, opcode); DISPATCH();
	_96:
	_97:
	_98:
	_99:
